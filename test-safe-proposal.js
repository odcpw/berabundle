 ...
 */
function encodeMultiSendTransactions(transactions) {
...
async function proposeSafeTransaction() {
    try {
        ...
        console.log(`\nBundle contains ${bundle.transactions.length} transactions`);
        ...
        // Step 6: Prepare transaction data - use MultiSend if multiple transactions
        let tx;
        ...
        if (bundle.transactions.length === 1) {
            ...
            console.log(`\nBundling ${bundle.transactions.length} transactions using MultiSend contract`);
            
            // Get MultiSendCallOnly contract address (uses regular CALL operation)
            ...
            const encodedTransactions = encodeMultiSendTransactions(bundle.transactions);
